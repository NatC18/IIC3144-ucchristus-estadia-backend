...
class TestExcelProcessor:
    ...
    def sample_excel_files(self, tmp_path):
        ...
        df1 = pd.DataFrame({
            ...
            'Especialidad médica de la intervención (des)': ['Cardiología', 'Traumatología'],
        ...
        df2 = pd.DataFrame({
            ...
            'fecha ingreso completa': ['2023-01-01 08:00:00', '2023-01-02 09:00:00'],
    ...
    def test_combine_data(self, sample_excel_files):
        ...
        assert combined_columns.intersection(episodio_variants), "No episodio column found"
    ...
    def test_invalid_excel_content(self, tmp_path):
        ...
        df = pd.DataFrame({
            'invalid_column': ['no_episodio_column']
        })
