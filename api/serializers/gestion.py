...
class GestionSerializer(serializers.ModelSerializer):
    ...
    estado_gestion_display = serializers.CharField(source='get_estado_gestion_display', read_only=True)
...
class GestionListSerializer(serializers.ModelSerializer):
    ...
    """
    episodio_id = serializers.UUIDField(source='episodio.id', read_only=True)
    paciente_nombre = serializers.CharField(source='episodio.paciente.nombre', read_only=True)
    usuario_nombre = serializers.SerializerMethodField()
    tipo_gestion_display = serializers.CharField(source='get_tipo_gestion_display', read_only=True)
    estado_gestion_display = serializers.CharField(source='get_estado_gestion_display', read_only=True)
